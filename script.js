...
const themePackPalette = {
  ...
  purple: {
      ...
      bottomNavBg: 'rgba(255, 255, 255, 0.92)',
      bottomNavShadow: '0 -6px 24px rgba(106, 75, 176, 0.16)',
      primaryShadow: 'rgba(106, 75, 176, 0.3)',
      secondaryBg: 'rgba(138, 107, 192, 0.08)',
      secondaryBorder: 'rgba(138, 107, 192, 0.15)',
      dangerBg: 'rgba(231, 104, 102, 0.08)',
      dangerBorder: 'rgba(231, 104, 102, 0.25)',
      btnBorderLight: 'rgba(106, 75, 176, 0.14)',
      btnShadowLight: '0 6px 18px rgba(106, 75, 176, 0.08)',
      btnHoverSoft: 'rgba(106, 75, 176, 0.08)',
      operatorBg: 'rgba(106, 75, 176, 0.12)',
      activeTabPrimaryLight: 'rgba(106, 75, 176, 0.95)',
      activeTabBorder: 'rgba(106, 75, 176, 0.35)',
    },
};
